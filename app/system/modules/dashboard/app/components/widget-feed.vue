    ...
    <div>
        ...
        <div v-show="status != 'loading'">
            ...
            <ul class="uk-list uk-list-line uk-margin-remove">
                <li v-for="(entry, index) in count(feed.entries)">
    ...
    export default {
        ...
        methods: {
            ...
            load: function () {
                ...
                this.$http.jsonp('//ajax.googleapis.com/ajax/services/feed/load', {
                    v: '1.0',
                    q: this.widget.url,
                    num: this.widget.count
                }).then(function (res) {
