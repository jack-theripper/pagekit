<template>
    <div>
        ...
        <div :class="'uk-overlay uk-overlay-hover uk-visible-hover' + this.class" v-else>
...
<script>
    module.exports = {
        ...
        methods: {
            ...
            hasSelection: function() { // @todo
                return false; // var a = this.$refs.modal.$slots.default[0].getSelected();
